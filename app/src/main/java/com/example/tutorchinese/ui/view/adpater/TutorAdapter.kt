...
class TutorAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, i: Int) {
        ...
        holder.tvName.text = item[i].T_name + " " + item[i].T_lastname
        holder.tvUsername.text = "ชื่อผู้ใช่: " + item[i].T_username
        holder.tvEmail.text = "อีเมล: " + item[i].T_email
        holder.tvTel.text = "เบอร์โทร: " + item[i].T_tel
